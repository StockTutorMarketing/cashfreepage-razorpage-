  ...
  return (
    <>
      <Box bgImage={bgimg} fontFamily={"roboto"} color={'#0a2472'} py={8}>
        ...
        gap={0}
        >
          <SimpleGrid gap={16} columns={{base:1, sm:1, md:1, lg:2}} justifyItems={"center"} alignItems={"center"}  paddingY={'8%'} justifyContent={'space-around'} margin={'auto'}>
            <Box width={'64%'} data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
              <Lottie animationData={Reading}/>
            </Box>

            <Stack gap={8} width={'80%'} margin={'auto'} data-aos="fade-left"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
          ...
          <SimpleGrid gap={8} columns={{base:1, sm:1, md:1, lg:2}} justifyItems={"center"} alignItems={"center"}  padding={'2%'} justifyContent={'space-around'} margin={'auto'}>

            <Stack paddingLeft={20} width={'100%'} gap={8} data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
              ...
              <SimpleGrid columns={{base:1, sm:1, md:1, lg:2}} gap={3} justifyContent={'center'} alignItems={'center'}>
            ...
            <Box width={'80%'} data-aos="fade-left"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
              <Lottie animationData={ManMoving}/>
            </Box>
          ...
          <SimpleGrid gap={16} columns={{base:1, sm:1, md:1, lg:2}} justifyItems={"center"} alignItems={"center"}  padding={'2%'} justifyContent={'space-around'} margin={'auto'}>
            <Box width={'80%'} data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
              <Lottie animationData={Girl}/>
            </Box>

            <Stack gap={8} width={'90%'} data-aos="fade-left"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
          ...
          <SimpleGrid gap={16} columns={{base:1, sm:1, md:1, lg:2}} justifyItems={"center"} alignItems={"center"}  padding={'2%'} justifyContent={'space-around'} margin={'auto'}>
            ...
            <Stack gap={8} width={'90%'} data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">
